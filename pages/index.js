    ...
    <div className="text-primary">
      ...
      <main className="flex flex-col items-center h-screen">
        ...
        <div className="mx-6 flex flex-col">
          <Link href="/dev" className="dev-link relative z-10 card mt-40 relative z-10 hover:text-yellow">
            <h3>Dev Work &rarr;</h3>
            <p className="dev-text">Explore Jackson's web development resume and portfolio</p>
          </Link>
        </div>
        <div className="mt-auto mb-20">
          <Link href="/music" className="music-link relative z-10 card inline-block relative z-10 hover:text-yellow">
            <h3>Music &rarr;</h3>
